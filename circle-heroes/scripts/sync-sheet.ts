...
function toHero(record: Record<string, string>): Hero {
  return {
    ...
    critRate: Number(record.crit_rate) || 0,
    critDmg: Number(record.crit_dmg) || 0,
    skill1Name: record.skill1_name,
    skill1Desc: record.skill1_desc,
    skill2Name: record.skill2_name,
    skill2Desc: record.skill2_desc,
